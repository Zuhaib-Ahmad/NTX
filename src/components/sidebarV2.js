...
const SideBar = props => {
  const data = useStaticQuery(graphql`
    query {
      topNavDocsV1: allDirectory(
        filter: { sourceInstanceName: { eq: "docs" }, relativeDirectory: { eq: "v0" } }
      ...
      docsV1: allMdx(
        filter: { fileAbsolutePath: { regex: "/docs/v0/" } }
      ...
      v2Reference: allFile(filter: { absolutePath: { regex: "/docs/v1/" }, ext: { eq: ".js" } }) {
        edges {
          node {
            name
            absolutePath
  ...
  const atTopLevel =
    props.path === '/docs/v0/' || props.path === '/docs/v1/' || props.path === '/docs/v1' || props.path === '/docs/v0'
      ...
      <ListWrapper>
        ...
        {atTopLevel && (
          <StyledList style={{ marginTop: '1rem' }}>
            ...
            <StyledListItem>
              <StyledLink to={'/docs/v1/smart-contracts/factory'}>Smart Contracts</StyledLink>
            </StyledListItem>
            <StyledListItem>
              <StyledLink to={'/docs/v1/SDK/getting-started'}>SDK</StyledLink>
            </StyledListItem>
            <StyledListItem>
