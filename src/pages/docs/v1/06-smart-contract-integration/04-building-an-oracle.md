...
To build a price oracle on Kwikswap V2, you must first understand the
...
[here](https://github.com/Kwikswap/kwikswap-v2-periphery/blob/master/contracts/examples/ExampleOracleSimple.sol).

<Github href="https://github.com/Kwikswap/kwikswap-v2-periphery/blob/master/contracts/examples/ExampleOracleSimple.sol">ExampleOracleSimple.sol</Github>
...
[here](https://github.com/Kwikswap/kwikswap-v2-periphery/blob/master/contracts/examples/ExampleSlidingWindowOracle.sol).
...
[this repository by Keydonix](https://github.com/Keydonix/kwikswap-oracle/).

<Github href="https://github.com/Keydonix/kwikswap-oracle">Keydonix: on-chain trustless and censorship resistant oracle</Github>

Keydonix has developed a general purpose price feed oracle built on Kwikswap that supports arbitrary time windows (up to 256 blocks) and doesn't require any active maintenance.
