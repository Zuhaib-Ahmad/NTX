...
Kwikswap is based on binary smart conntract. [Core](#core) These contracts assure the fundamental security for all the parties interacting with Kwikswap. 
...
[Source code](https://github.com/Kwikswap/kwikswap-v1-core)
...
[Source code](https://github.com/Kwikswap/kwikswap-v1-periphery)

The periphery is a constellation of smart contracts designed to support domain-specific interactions with the core. Because of Kwikswap's permissionless nature, the contracts described below have no special privileges, and are in fact only a small subset of the universe of possible periphery-like contracts. However, they are useful examples of how to safely and efficiently interact with Kwikswap V1.
...
The following sections describe some of the notable design decisions made in Kwikswap V1. These are safe to skip unless you're interested in gaining a deep technical understanding of how V1 works under the hood, or writing smart contract integrations!
